...
import useCurrentBookStore from '@/stores/useCurrentBookStore.ts';
...
function NotePage() {
  ...
  const {name} = useCurrentBookStore()
      ...
      <>
        <div className="flex h-screen overflow-hidden">
          ...
          <aside className="w-1/6">
            <FileExplorer refreshFileExplorer={refreshFileExplorer} bookId={bookId || ""} language={name} fileExplorerData={tree} setSelectionCallbackFunction={handleSetSelection}/>
          </aside>
          ...
          <main className="flex-1 p-6">
            {
              ...
              <>
                ...
                <TranslationCardSection setId={selectedSet.id} isEditMode={isEditMode} refreshFileExplorer={refreshFileExplorer}/>
              </>
            }
          </main>
        </div>
